    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('forum.index') }}"
                           class="flex items-center justify-between px-3 py-2 rounded-lg {{ !request()->route('channel') ? 'bg-indigo-600 text-white font-medium' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ $discussions->total() }} active conversations</p>
            </div>
